define(['jquery',
        'handlebars',
        'text!faostat_ui_breadcrumbs/html/templates.html',
        'i18n!faostat_ui_breadcrumbs/nls/translate',
        'faostat_commons',
        'wds_client',
        'bootstrap',
        'sweetAlert',
    ...
    function BREADCRUMBS() {
        ...
        this.CONFIG = {
            ...
            w: null,
            lang: 'E',
            prefix: 'faostat_ui_breadcrumbs_',
            placeholder_id: 'faostat_ui_breadcrumbs',
    ...
    BREADCRUMBS.prototype.init = function(config) {
